      ...
      <div className="relative hidden w-1/2 lg:flex lg:flex-col lg:justify-between p-12 overflow-hidden bg-emerald-900">
        ...
        <div className="relative z-10 max-w-lg pb-12">
          <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-5xl leading-tight">
            Cultivate insights.<br />Grow with intelligence.
          </h1>
          <p className="mt-6 text-lg text-emerald-100/80 leading-relaxed font-light">
            An AI-powered farm management system for multi-block almond farms. Real-time data, smarter agronomic decisions.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto w-full max-w-sm lg:max-w-md">
          ...
          <div className="mb-10">
            ...
            <p className="mt-2 text-sm text-zinc-500">
              Sign in to your account to manage your farm.
            </p>
          </div>
            ...
            <form action={login} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="block w-full rounded-xl border-0 py-3 pl-10 pr-3 text-zinc-900 shadow-sm ring-1 ring-inset ring-zinc-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 transition-all duration-200"
              ...
              <div className="flex items-center justify-between mt-6">
                <div className="flex items-center gap-2">
                  ...
                  <label
                    htmlFor="remember-me"
                    className="block text-sm leading-6 text-zinc-700 cursor-pointer"
                  >
                    Remember me
                  </label>
                </div>
